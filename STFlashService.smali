...
.method private startForegroundService(Ljava/lang/String;Landroid/content/Intent;)V
    ...
    invoke-virtual {v7, v0}, Lcom/pripla/cosmo/stflash/STFlashService;->getSystemService(Ljava/lang/String;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Landroid/app/NotificationManager;

    iput-object v0, v7, Lcom/pripla/cosmo/stflash/STFlashService;->notificationManager:Landroid/app/NotificationManager;
    ...
    .line 204
    const-string v0, "st_flash__channel"
    ...
    const-string v3, "ST Flash channel"
    ...
    .line 212
    iget-object v3, v7, Lcom/pripla/cosmo/stflash/STFlashService;->notificationManager:Landroid/app/NotificationManager;
    ...
    :cond_0
    const-string v12, "Cover Display Assistant"

    .line 218
    .local v12, "msg":Ljava/lang/String;
    new-instance v0, Landroid/content/Intent;

    const-class v1, Lcom/pripla/cosmo/stflash/MainActivity;
    ...
    .line 219
    .local v13, "intentDefault":Landroid/content/Intent;
    const-string v0, "notify_default_tap"

    const/4 v14, 0x1

    invoke-virtual {v13, v0, v14}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Z)Landroid/content/Intent;
    ...
    .line 221
    :cond_1
    const-string v0, "notification_default"

    invoke-virtual {v13, v0}, Landroid/content/Intent;->setAction(Ljava/lang/String;)Landroid/content/Intent;

    .line 222
    :goto_0
    invoke-static {v7, v11, v13, v11}, Landroid/app/PendingIntent;->getActivity(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;

    move-result-object v15

    .line 224
    .local v15, "piDefault":Landroid/app/PendingIntent;
    ...
    invoke-direct {v0, v7, v3}, Landroid/app/Notification$Builder;-><init>(Landroid/content/Context;Ljava/lang/String;)V
    ...
    .line 234
    invoke-virtual {v0, v11, v11, v14}, Landroid/app/Notification$Builder;->setProgress(IIZ)Landroid/app/Notification$Builder;
    ...
    iput-object v0, v7, Lcom/pripla/cosmo/stflash/STFlashService;->builder:Landroid/app/Notification$Builder;

    .line 238
    iget-object v0, v7, Lcom/pripla/cosmo/stflash/STFlashService;->builder:Landroid/app/Notification$Builder;
    ...
    invoke-virtual {v7, v3, v0}, Lcom/pripla/cosmo/stflash/STFlashService;->startForeground(ILandroid/app/Notification;)V
    ...
    .line 243
    iput-boolean v11, v7, Lcom/pripla/cosmo/stflash/STFlashService;->mPoll:Z

    .line 244
    invoke-virtual/range {p0 .. p0}, Lcom/pripla/cosmo/stflash/STFlashService;->getApplicationContext()Landroid/content/Context;
    ...
    invoke-virtual {v9, v3, v1}, Landroid/content/Intent;->getIntExtra(Ljava/lang/String;I)I

    move-result v1

    iput v1, v7, Lcom/pripla/cosmo/stflash/STFlashService;->mState:I
    ...
    iget v4, v7, Lcom/pripla/cosmo/stflash/STFlashService;->mState:I
    ...
    .line 253
    new-instance v3, Lcom/pripla/cosmo/stflash/STFlashService$FlashAsyncTask;

    invoke-direct {v3, v7, v10}, Lcom/pripla/cosmo/stflash/STFlashService$FlashAsyncTask;-><init>(Lcom/pripla/cosmo/stflash/STFlashService;Lcom/pripla/cosmo/stflash/STFlashService$1;)V

    iput-object v3, v7, Lcom/pripla/cosmo/stflash/STFlashService;->mFlashAsyncTask:Lcom/pripla/cosmo/stflash/STFlashService$FlashAsyncTask;

    .line 254
    iget-object v3, v7, Lcom/pripla/cosmo/stflash/STFlashService;->mFlashAsyncTask:Lcom/pripla/cosmo/stflash/STFlashService$FlashAsyncTask;

    new-array v4, v14, [Ljava/lang/String;

    aput-object v1, v4, v11

    invoke-virtual {v3, v4}, Lcom/pripla/cosmo/stflash/STFlashService$FlashAsyncTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;
    ...
    iput v0, v7, Lcom/pripla/cosmo/stflash/STFlashService;->mState:I

    .line 264
    const-string v0, "flash"

    iget v1, v7, Lcom/pripla/cosmo/stflash/STFlashService;->mState:I
    ...
    .line 265
    iget v0, v7, Lcom/pripla/cosmo/stflash/STFlashService;->mState:I
    ...
    iput-object v0, v7, Lcom/pripla/cosmo/stflash/STFlashService;->STBuildNo:Ljava/lang/String;

    .line 268
    const-string v0, ""

    iput-object v0, v7, Lcom/pripla/cosmo/stflash/STFlashService;->STBuildNoOriginal:Ljava/lang/String;

    .line 269
    iput-boolean v11, v7, Lcom/pripla/cosmo/stflash/STFlashService;->mVersionReceived:Z
    ...
    .line 272
    iget-object v1, v7, Lcom/pripla/cosmo/stflash/STFlashService;->mAmoledisonReceiver:Landroid/content/BroadcastReceiver;

    invoke-virtual {v7, v1, v0}, Lcom/pripla/cosmo/stflash/STFlashService;->registerReceiver(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)Landroid/content/Intent;
    ...
    const-string v3, "AMOLEDISON is NULL"
    ...
    invoke-virtual {v1, v2, v3}, Landroid/os/AmoledisonManager;->setData(ILjava/lang/String;)V
    ...
    new-instance v3, Lcom/pripla/cosmo/stflash/STFlashService$2;

    invoke-direct {v3, v7}, Lcom/pripla/cosmo/stflash/STFlashService$2;-><init>(Lcom/pripla/cosmo/stflash/STFlashService;)V
    ...
    .line 286
    .local v11, "size":J
    new-instance v17, Lcom/pripla/cosmo/stflash/STFlashService$FileInfo;

    const-string v0, "parPath"
    ...
    invoke-direct/range {v0 .. v6}, Lcom/pripla/cosmo/stflash/STFlashService$FileInfo;-><init>(Lcom/pripla/cosmo/stflash/STFlashService;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;J)V

    .line 287
    .local v0, "fi":Lcom/pripla/cosmo/stflash/STFlashService$FileInfo;
    new-instance v1, Lcom/pripla/cosmo/stflash/STFlashService$DownloadFileTask;

    invoke-direct {v1, v7, v10}, Lcom/pripla/cosmo/stflash/STFlashService$DownloadFileTask;-><init>(Lcom/pripla/cosmo/stflash/STFlashService;Lcom/pripla/cosmo/stflash/STFlashService$1;)V

    iput-object v1, v7, Lcom/pripla/cosmo/stflash/STFlashService;->mDownloadFileTask:Lcom/pripla/cosmo/stflash/STFlashService$DownloadFileTask;

    .line 288
    iget-object v1, v7, Lcom/pripla/cosmo/stflash/STFlashService;->mDownloadFileTask:Lcom/pripla/cosmo/stflash/STFlashService$DownloadFileTask;

    new-array v2, v14, [Lcom/pripla/cosmo/stflash/STFlashService$FileInfo;

    const/4 v3, 0x0

    aput-object v0, v2, v3

    invoke-virtual {v1, v2}, Lcom/pripla/cosmo/stflash/STFlashService$DownloadFileTask;->execute([Ljava/lang/Object;)Landroid/os/AsyncTask;

    .line 290
    .end local v0    # "fi":Lcom/pripla/cosmo/stflash/STFlashService$FileInfo;
    ...
    .line 291
    iget-object v0, v7, Lcom/pripla/cosmo/stflash/STFlashService;->notificationManager:Landroid/app/NotificationManager;
    ...
    .line 294
    invoke-virtual {v7, v14}, Lcom/pripla/cosmo/stflash/STFlashService;->stopForeground(Z)V

    .line 295
    invoke-virtual/range {p0 .. p0}, Lcom/pripla/cosmo/stflash/STFlashService;->stopSelf()V
...
.method private stopExplicit()V
    ...
    invoke-virtual {p0, v1}, Lcom/pripla/cosmo/stflash/STFlashService;->stopForeground(I)V
...
.method private stopExplicitRemoveNotification()V
    .locals 4
    ...
    invoke-virtual {p0, v1}, Lcom/pripla/cosmo/stflash/STFlashService;->stopForeground(Z)V
...
.method private stopForegroundService()V
    ...
    .line 302
    iget-object v0, p0, Lcom/pripla/cosmo/stflash/STFlashService;->mDownloadFileTask:Lcom/pripla/cosmo/stflash/STFlashService$DownloadFileTask;
    ...
    invoke-virtual {v0, v1}, Lcom/pripla/cosmo/stflash/STFlashService$DownloadFileTask;->cancel(Z)Z
    ...
    new-instance v1, Lcom/pripla/cosmo/stflash/STFlashService$3;

    invoke-direct {v1, p0}, Lcom/pripla/cosmo/stflash/STFlashService$3;-><init>(Lcom/pripla/cosmo/stflash/STFlashService;)V
